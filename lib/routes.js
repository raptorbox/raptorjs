...
routes.ACTION_INVOKE = "/actuation/%s/%s"
...
routes.TOKEN_LIST = routes.TOKEN_CREATE
...
routes.APP_DELETE_USER = routes.APP_CREATE + "/%s/deleteUser/%s"
routes.APP_SUPPORTED_CODEC = routes.APP_CREATE + "/payloadcodec/supported"
...
routes.WORKFLOW_CREATE = routes.WORKFLOW_LIST
routes.WORKFLOW_GET = routes.WORKFLOW_LIST + "%s"
routes.WORKFLOW_DELETE = routes.WORKFLOW_GET
routes.WORKFLOW_START = routes.WORKFLOW_GET + "/start"
routes.WORKFLOW_STOP = routes.WORKFLOW_GET + "/stop"

routes.DIAGNOSTICS_DEVICE = "/diagnostics/devices"
