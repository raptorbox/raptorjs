...
var ServiceObject = function (obj, container) {
  ...
  this.permission = (function(p) {
    return {
      add: function(user, permission) {
        return p.add(me, user, permission);
      },
      remove: function(user, permission) {
        return p.remove(me, user, permission);
      },
      list: function(user, permission) {
        return p.list(me, user, permission);
      },
      set: function(user, permission) {
        return p.set(me, user, permission);
      }
    };
