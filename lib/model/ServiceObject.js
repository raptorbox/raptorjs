 ...
 * Get tree
 *
 * @return {Promise} Promise of the request with the tree path
 */
ServiceObject.prototype.tree = function () {
  return this.client.get('/' + this.getId() + '/tree').bind(this)
};
...
ServiceObject.prototype.addChild = function (obj) {
  return this.client.put('/' + this.getId() + '/tree/' + (obj.id || obj)).bind(this)
};
...
ServiceObject.prototype.removeChild = function (obj) {
  return this.client.delete('/' + this.getId() + '/tree/' + (obj.id || obj)).bind(this)
};
